...
# OwnROM version
ifndef OWNROM_RELEASE_TYPE
OWNROM_RELEASE_TYPE = UNOFFICIAL
endif
OWNROM_VERSION_MAJOR = PRE_ALPHA
OWNROM_VERSION_MINOR = V3.0

# Release
    OWNROM_VERSION := OwnROM-$(OWNROM_RELEASE_TYPE)-$(OWNROM_VERSION_MAJOR)-$(OWNROM_VERSION_MINOR)-$(shell date -u +%Y%m%d)-$(OWNROM_BUILD)

# Display Version
	OWNROM_DISPLAY_VERSION := OwnROM-$(OWNROM_RELEASE_TYPE)-$(OWNROM_VERSION_MAJOR)-$(OWNROM_VERSION_MINOR)-$(OWNROM_BUILD)
...
# CyanogenMod Platform SDK Version used in OwnROM
PRODUCT_PROPERTY_OVERRIDES += \
  ro.cm.build.version.plat.sdk=$(CM_PLATFORM_SDK_VERSION)

# CyanogenMod Platform Internal used in OwnROM
PRODUCT_PROPERTY_OVERRIDES += \
